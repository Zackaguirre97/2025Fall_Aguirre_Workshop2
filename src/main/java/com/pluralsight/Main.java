...
public class Main {
    public static void main(String[] args) {
        ...
        // Create a new instance of the library controller by passing the above library to the controller.
        LibraryController controller = new LibraryController(library, sc);
        // Start/Run the controller
        controller.start();
    }
}
